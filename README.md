...
Exercício 4.2
Crie uma função que receba nome, curso e duas notas e retorne uma mensagem formatada informando que o {nome} matriculado no curso {curso} está {“Aprovado”|”Reprovado”}, essa implementação deve se dar por meio de um módulo.
